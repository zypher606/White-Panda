                            ...
                            <form action="<?php echo $action; ?>" method="post" name="payuForm">
                              ...
                              <table>
                                ...
                                <tr>
                                  ...
                                  <td><input type="hidden" name="amount" id="product_name" value="<?php echo (empty($posted['amount'])) ? $quality: $posted['amount'] ?>" /></td>
                                ...
                                <tr>
                                  ...
                                  <td colspan="3"><input type="hidden" name="surl" value="<?php echo (empty($posted['surl'])) ? 'http://whitepanda.in/successs.php' : $posted['surl'] ?>" size="64" /></td>
                                </tr>
                                <tr>
