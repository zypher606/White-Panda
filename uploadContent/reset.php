...
<div class="bus_login">
            ...
            <form class='f1' action="php/reset.php" method="post" id="reset">
                ...
                <legend><h3>Reset Your Password.</h3></legend>
                  ...
                  <p><input id="password2" class="textbox" name="password2" type="password" placeholder="Re-type">
                  <input name="action" type="hidden" value="'.$encrypt.'" /></p>
                  <p><input id='create' type="button" value="Reset" onclick="mypasswordmatch();" /></p>
                </fieldset>
            </form>
